...
class Photo(models.Model):
    photo_id = models.AutoField(primary_key=True, null=False)
    photo_name = models.CharField(max_length=50)
    photo = models.ImageField(upload_to='imgs')
    description = models.CharField(max_length=100)
    click = models.IntegerField()
    # content_time = models.DateTimeField(null=True, blank=True, auto_now_add=True)
    category_photo = models.ForeignKey('CategoryPhoto', on_delete=models.CASCADE)
...
class CategoryPhoto(models.Model):
    cate_id = models.AutoField(primary_key=True, null=False)
