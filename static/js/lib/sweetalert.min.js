...
var defaultInputValidators = {
  email: function email(string, extraParams) {
    return (/^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(string) ? Promise.resolve() : Promise.reject(extraParams && extraParams.validationMessage ? extraParams.validationMessage : 'Invalid mail.py address')
    );
  },
  ...
  return new Promise(function (resolve, reject) {
    ...
    switch (innerParams.input) {
      ...
      case null:
        break;
      default:
        error('Unexpected type of input! Expected "text", "mail.py", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "' + innerParams.input + '"');
        break;
    }
