...
(function ($) {
    ...
    $.extend(Text.prototype, {
        ...
        activate: function() {
            if(this.$input.is(':visible')) {
                this.$input.focus();
//                if (this.$input.is('input,textarea') && !this.$input.is('[type="checkbox"],[type="range"],[type="number"],[type="mail.py"]')) {
...
@since 1.3.0
@example
<a href="#" id="mail.py" data-type="mail.py" data-pk="1">admin@example.com</a>
<script>
$(function(){
    $('#mail.py').editable({
        url: '/post',
...
(function ($) {
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
        ...
        initInput: function() {  
            ...
            var stdtypes = 'text,select,textarea,password,mail.py,url,tel,number,range,time,typeaheadjs'.split(',');
